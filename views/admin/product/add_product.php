<!-- Page Content -->
<main class="flex-1 px-4 overflow-y-auto md:px-6 bg-gray-50">
    <!-- Page title and actions -->
    <div class="flex flex-col justify-between mb-6 md:flex-row md:items-center">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Add New Products</h1>
            <p class="mt-1 text-gray-600">Fill out the form below to add a new product to the catalog.</p>
        </div>
    ...
    <div class="max-w-6xl mx-auto">
        <div class="overflow-hidden bg-white border border-gray-200 shadow-sm rounded-xl">
            ...
            <!-- Form Content -->
            <form data-form-add-product class="p-6">
                    ...
                    <div class="lg:col-span-1">
                        <div class="space-y-4">
                            ...
                            <div class="p-6 text-center transition-colors duration-200 border-2 border-gray-300 border-dashed rounded-xl hover:border-amber-400">
                                <div data-image-wrapper class="hidden mb-4">
...
<!-- Description -->
                            <div>
                                ...
                                <div class="flex justify-between mt-2">
                                    ...
                                    <p id="char-count" class="text-xs text-gray-500">0/500 characters</p>
                                </div>
                            </div>
...
<!-- Status Dropdown -->
                            <div>
                                ...
                                <div class="grid grid-cols-1 gap-3 md:grid-cols-2">
                                    <div class="relative">
                                        <input type="radio" id="status-active" name="status" value="active" class="hidden peer" checked>
                                    ...
                                    <div class="relative">
                                        <input type="radio" id="status-deactive" name="status" value="deactive" class="hidden peer">
...
<!-- Form Actions -->
                <div class="flex flex-col justify-end pt-6 mt-8 space-y-3 border-t border-gray-200 sm:flex-row sm:space-y-0 sm:space-x-3">
                    <button type="submit" class="px-5 py-2.5 bg-amber-500 hover:bg-amber-600 text-white rounded-lg font-medium transition-colors">
                        <i class="mr-2 bi bi-cloud-arrow-up"></i>Add Product
                    </button>
                </div>
            </form>
        </div>
